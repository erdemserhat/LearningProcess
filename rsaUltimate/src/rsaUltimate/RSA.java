...
public class RSA {
	...
	static BigInteger publicKey=new BigInteger("197"); // !! "E" stands for public key
	...
	static BigInteger privateKey= new BigInteger("90981"); //"D" stands for public key
	...
	public static void main(String[] args) {
		...
		MainMenu();
		//PrimeNumberFinder(500,600); // to define p and q values.
		//PublicKeyGenerator();
		//PrivateKeyGenerator();
...
//**************************************Message Input*********************************************************************
		...
		String showing="";
		for(int i=0; i<message.length(); i++) { //priting every chipper text by seperating comma
			if(i==0) showing+=chipperInt[i];
			else showing+="," +chipperInt[i];
		}
		String ultimateShowing = "{" +showing +"};"; //deleting last comma and editing for code
...
//***************************************Chipper Text Input**************************************************************************
		...
		int [] chipperInt= {284270,125364,14292,279841,271390,296527};
